...
sequenceDiagram
    ...
    activate Contract
    Note over Contract: Deposit PROPOSAL_COLLATERAL (5 XLM) + abstain vote deposit (2 XLM)
    ...
    activate Contract
    Note over Contract: Validate commitment structure (3 G1 points)<br/>Check voter eligibility & weight<br/>Deposit VOTE_COLLATERAL (2 XLM)
